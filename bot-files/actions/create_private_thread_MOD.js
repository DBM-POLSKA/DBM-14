module.exports = {
  ...
  meta: {
    ...
    downloadURL:
      "https://github.com/DBM-POLSKA/DBM-14/blob/DBM-v14/actions/create_private_thread_MOD.js",
  },
  fields: [
    "channel",
    "channelVarName",
  ...
  subtitle(data, presets) {
    return `Create Private Thread In ${presets.getChannelText(
      data.channel ?? 0,
      data.channelVarName
    )}`;
  },
  ...
  async action(cache) {
    ...
    const thread = await channel.threads.create({
      ...
      autoArchiveDuration:
        data.autoArchiveDuration === "max"
          ? 10080
          : parseInt(data.autoArchiveDuration, 10),
